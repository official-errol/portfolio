...
const Blog: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Title and Search */}
      <div className="max-w-6xl mx-auto px-4 py-2 grid grid-cols-1 md:grid-cols-2 md:items-center gap-4">
      ...
      <div className="max-w-6xl mx-auto px-4 py-2 flex flex-col md:flex-row gap-8">
        {/* Main Section */}
