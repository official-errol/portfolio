...
const Contact: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-[80vh] flex flex-col justify-center items-center px-4 py-6 lg:py-8">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 lg:mb-6">
            Get In Touch
          </h1>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-10">
            ...
            <div className="flex-1 space-y-4">
              ...
              >
                <h2 className="text-xl font-semibold mb-4 text-main-dark">Contact Information</h2>
                ...
                <div className="space-y-4 text-sm">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Lipa City, Batangas 4217, Philippines</p>
                    </div>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <h2 className="text-xl font-semibold mt-4 text-main-dark">Let's Connect</h2>
            ...
            >
              <form
                ...
                className="h-full px-4 py-5 rounded-xl bg-white/30 backdrop-blur-md border border-gray-500/20 space-y-4 text-sm"
              >
                {['name', 'email', 'subject'].map((field) => (
                  <div key={field}>
                    <label htmlFor={field} className="block text-gray-700 mb-1 capitalize">{field}</label>
                    <input
                      id={field}
                      type={field === 'email' ? 'email' : 'text'}
                      className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-main ${
                    ...
                    {errors[field as keyof FormData] && (
                      <p className="text-red-500 mt-1 text-xs">{errors[field as keyof FormData]?.message}</p>
                    )}
                  </div>
                ))}
                ...
                <div>
                  ...
                  ></textarea>
                  {errors.message && (
                    <p className="text-red-500 mt-1 text-xs">{errors.message.message}</p>
                  )}
                </div>
