      ...
      <div className="rounded-xl bg-white/30 backdrop-blur-md border border-gray-500/20 overflow-hidden">
        <div className="p-2 pb-4 border-b border-gray-200">
          <div className="relative flex items-center">
            {/* Centered user info */}
            <div className="absolute left-1/2 -translate-x-1/2 w-fit flex items-center">
            ...
            <div className="ml-auto">
              <button
                onClick={logout}
                className="flex items-center gap-3 h-10 py-3 px-4 text-xs text-white bg-red-500 rounded-lg cursor-pointer select-none
