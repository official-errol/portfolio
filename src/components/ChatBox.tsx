    ...
    <div className="flex flex-col h-full">
      ...
      <form onSubmit={handleSubmit} className="p-2 flex border-t border-gray-200 dark:border-gray-700">
        <input
          ...
          className="flex-1 px-3 py-3 mr-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-main"
          aria-label="Type your message"
        />
        <button
          type="submit"
          disabled={!newMessage.trim()}
          className={`h-10 w-10 flex items-center justify-center text-main-dark bg-main rounded-lg cursor-pointer select-none
